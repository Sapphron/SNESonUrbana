...
struct TEXT_HDMI_STRUCT {
	...
	uint8_t				blankspace[4*(2048-1200)]; // should take care of the extra area
	uint32_t				colors[8];
...
void setColorPalette (uint8_t color, uint8_t red_b, uint8_t green_b, uint8_t blue_b, uint8_t red_a, uint8_t green_a, uint8_t blue_a); //Fill in this code
void paletteTest();
