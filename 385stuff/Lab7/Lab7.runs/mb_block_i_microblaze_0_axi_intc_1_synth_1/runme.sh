...
HD_PWD='C:/Users/sapph/OneDrive/Documents/GitHub/ECE385-SP24/Lab7/Lab7.runs/mb_block_i_microblaze_0_axi_intc_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_block_i_microblaze_0_axi_intc_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_block_i_microblaze_0_axi_intc_1.tcl
