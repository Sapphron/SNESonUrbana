...
#
# Generated by Vivado on Sat May 04 18:24:05 -0500 2024
...
simulate()
{
  xsim  clk_wiz_0 -key {Behavioral:sim_1:Functional:clk_wiz_0} -tclbatch cmd.tcl -protoinst "protoinst_files/mb_block_i.protoinst" -log simulate.log
}
