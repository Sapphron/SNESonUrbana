...
#
# Generated by export_simulation on Tue Apr 30 11:39:27 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './blk_mem_gen_aram.sh' script.

./blk_mem_gen_aram.sh -reset_run
...
./blk_mem_gen_aram.sh -noclean_files

For more information on the script, please type './blk_mem_gen_aram.sh -help'.
