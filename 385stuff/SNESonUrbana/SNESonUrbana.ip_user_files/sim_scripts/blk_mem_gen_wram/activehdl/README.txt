...
#
# Generated by export_simulation on Tue Apr 30 11:37:18 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './blk_mem_gen_wram.sh' script.

./blk_mem_gen_wram.sh -reset_run
...
./blk_mem_gen_wram.sh -noclean_files

For more information on the script, please type './blk_mem_gen_wram.sh -help'.
