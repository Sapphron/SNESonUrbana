...
#
# Generated by Vivado on Fri May 03 02:31:27 -0500 2024
...
simulate()
{
  xsim  clk_wiz_0 -key {Behavioral:sim_1:Functional:clk_wiz_0} -tclbatch cmd.tcl -protoinst "protoinst_files/snes_block.protoinst" -log simulate.log
}
