...
#
# Generated by export_simulation on Wed May 01 20:06:17 -0500 2024
#
################################################################################
...
'-reset_run' switch to the './blk_mem_gen_oam.sh' script.

./blk_mem_gen_oam.sh -reset_run
...
./blk_mem_gen_oam.sh -noclean_files

For more information on the script, please type './blk_mem_gen_oam.sh -help'.
