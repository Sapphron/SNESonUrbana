...
//XPAR_GPIO_1_BASEADDR = XPAR_MIG_7SERIES_0_BASEADDR;

//uint32_t ddr3_rom_addr = XPAR_MIG_7SERIES_0_BASEADDR;
//uint32_t *romdata = XPAR_GPIO_1_BASEADDR;
//uint32_t *romaddr = XPAR_GPIO_0_BASEADDR;
//uint32_t offset;
//uint32_t dataaddr;
//uint32_t datalol;
...
//   	offset = *romaddr;
//   	dataaddr = ddr3_rom_addr + offset;
//   	datalol = *dataaddr;
//   	*romdata = datalol;

//   	*romdata = ddr3_rom_addr + *romaddr + 24992; // offset will have to change
//   	xil_printf("%p", &cart_bin);
