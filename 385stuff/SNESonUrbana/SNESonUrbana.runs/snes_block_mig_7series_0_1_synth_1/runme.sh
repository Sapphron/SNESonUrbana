...
HD_PWD='C:/Users/sapph/OneDrive/Documents/GitHub/ECE385-SP24/SNESonUrbana/SNESonUrbana.runs/snes_block_mig_7series_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log snes_block_mig_7series_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source snes_block_mig_7series_0_1.tcl
