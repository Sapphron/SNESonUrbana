...
HD_PWD='C:/Users/sapph/OneDrive/Documents/GitHub/ECE385-SP24/SNESonUrbana/SNESonUrbana.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SNES_toplevel.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SNES_toplevel.tcl -notrace
