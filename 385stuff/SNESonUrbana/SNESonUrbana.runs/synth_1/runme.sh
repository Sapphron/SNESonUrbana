...
HD_PWD='C:/Users/sapph/OneDrive/Documents/GitHub/ECE385-SP24/SNESonUrbana/SNESonUrbana.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SNES_toplevel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SNES_toplevel.tcl
