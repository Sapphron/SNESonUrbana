...
//               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ blk_mem_brr_buf_stub.v
...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clka, ena, wea, addra, dina, douta, clkb, enb, web, addrb, 
  dinb, doutb)
/* synthesis syn_black_box black_box_pad_pin="clka,ena,wea[0:0],addra[6:0],dina[6:0],douta[6:0],clkb,enb,web[0:0],addrb[6:0],dinb[6:0],doutb[6:0]" */;
  input clka;
  input ena;
  input [0:0]wea;
  input [6:0]addra;
